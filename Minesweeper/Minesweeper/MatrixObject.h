...
struct matrixObject
{
	...
	bool isVisible = true; // This variable decides if the field is rendered depending on objType or as an X. Also decides if the field can be poked or not in the function pokeField().
